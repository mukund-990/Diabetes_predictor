...
import csv
df = pd.read_csv(r'D:\1stpy\diabetes.csv')
...
def user_report():
  ...
  bmi = st.sidebar.number_input('BMI', 0,67, 20 )
  dpf = st.sidebar.number_input('Diabetes Pedigree Function', 0.0,2.4, 0.47 )
  age = st.sidebar.number_input('Age', 21,88, 33 )
...
user_result = rf.predict(user_data.values.reshape(1, -1))
